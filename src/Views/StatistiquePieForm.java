...
//        });
        ...
        RadioButton popular = RadioButton.createToggle("equipe points", barGroup);
        popular.setUIID("SelectBar");
        RadioButton equipe = RadioButton.createToggle("Equipe", barGroup);
        equipe.setUIID("SelectBar");
        RadioButton classement = RadioButton.createToggle("nbPOunts", barGroup);
        classement.setUIID("SelectBar");
        Label arrow = new Label(res.getImage("news-tab-down-arrow.png"), "Container");
        
        add(LayeredLayout.encloseIn(
                GridLayout.encloseIn(3, all, popular,equipe),
...
//    }
  ...
  ;       
       ...
       image.addActionListener(e -> {
           try{
           new AjouterEquipe(Resources.getGlobalResources()).show();
           }catch(Exception exx) {
    ...
    private CategorySeries buildDataset(String title, double prcntFeed, double prcntRec) {
        ...
        series.add("equipe",prcntRec);
        series.add("points",prcntFeed);
